...
class Ckesehatanjiwa extends CI_Controller
{
	public function __construct()
	{
		...
		$this->load->model('Mkesehatanjiwa');
	}

	public function index()
	{
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/kesehatanjiwa/Vindex');
	}

	public function create()
	{
        $data['icd'] = $this->Mkesehatanjiwa->geticd();
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/kesehatanjiwa/Vcreate', $data);
	}
