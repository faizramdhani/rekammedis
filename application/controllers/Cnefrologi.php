...
class Cnefrologi extends CI_Controller
{
	public function __construct()
	{
		...
		$this->load->model('Mnefrologi');
	}

	public function index()
	{
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/nefrologi/Vindex');
	}

	public function create()
	{
        $data['icd'] = $this->Mnefrologi->geticd();
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/nefrologi/Vcreate', $data);
	}
