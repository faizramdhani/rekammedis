...
class Cmata extends CI_Controller
{
	public function __construct()
	{
		...
		$this->load->model('Mmata');
	}

	public function index()
	{
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/mata/Vindex');
	}

	public function create()
	{
        $data['icd'] = $this->Mmata->geticd();
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/mata/Vcreate', $data);
	}
