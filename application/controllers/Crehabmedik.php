...
class Crehabmedik extends CI_Controller
{
	public function __construct()
	{
		...
		$this->load->model('Mrehabmedik');
	}

	public function index()
	{
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/rehabmedik/Vindex');
	}

	public function create()
	{
        $data['icd'] = $this->Mrehabmedik->geticd();
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/rehabmedik/Vcreate', $data);
	}
