...
class Cobstetriginekologi extends CI_Controller
{
	public function __construct()
	{
		...
		$this->load->model('Mobstetriginekologi');
	}

	public function index()
	{
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/obstetriginekologi/Vindex');
	}

	public function create()
	{
        $data['icd'] = $this->Mobstetriginekologi->geticd();
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/obstetriginekologi/Vcreate', $data);
	}
