...
class Cbedahsyaraf extends CI_Controller
{
	public function __construct()
	{
		...
		$this->load->model('Mbedahsyaraf');
	}

	public function index()
	{
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/bedahsyaraf/Vindex');
	}

	public function create()
	{
        $data['icd'] = $this->Mbedahsyaraf->geticd();
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/bedahsyaraf/Vcreate', $data);
	}
