...
class Cortopedi extends CI_Controller
{
	public function __construct()
	{
		...
		$this->load->model('Mortopedi');
	}

	public function index()
	{
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/ortopedi/Vindex');
	}

	public function create()
	{
        $data['icd'] = $this->Mortopedi->geticd();
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/ortopedi/Vcreate', $data);
	}
