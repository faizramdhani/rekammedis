...
class Cbtkv extends CI_Controller
{
	public function __construct()
	{
		...
		$this->load->model('Mbtkv');
	}

	public function index()
	{
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/btkv/Vindex');
	}

	public function create()
	{
        $data['icd'] = $this->Mbtkv->geticd();
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/btkv/Vcreate', $data);
	}
