...
class Cjantung extends CI_Controller
{
	public function __construct()
	{
		...
		$this->load->model('Mjantung');
	}

	public function index()
	{
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/jantung/Vindex');
	}

	public function create()
	{
        $data['icd'] = $this->Mjantung->geticd();
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/jantung/Vcreate', $data);
	}
