...
class Cpenyakitdalam extends CI_Controller
{
	public function __construct()
	{
		...
		$this->load->model('Mpenyakitdalam');
	}

	public function index()
	{
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/penyakitdalam/Vindex');
	}

	public function create()
	{
        $data['icd'] = $this->Mpenyakitdalam->geticd();
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/penyakitdalam/Vcreate', $data);
	}
