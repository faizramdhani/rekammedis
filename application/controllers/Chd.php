...
class Chd extends CI_Controller
{
	...
	{
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/hd/Vindex');
	}

	public function create()
	{
        $data['icd'] = $this->Mhd->geticd();
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/hd/Vcreate', $data);
	}
