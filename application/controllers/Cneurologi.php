...
class Cneurologi extends CI_Controller
{
	public function __construct()
	{
		...
		$this->load->model('Mneurologi');
	}

	public function index()
	{
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/neurologi/Vindex');
	}

	public function create()
	{
        $data['icd'] = $this->Mneurologi->geticd();
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/neurologi/Vcreate', $data);
	}
