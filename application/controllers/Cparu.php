...
class Cparu extends CI_Controller
{
	public function __construct()
	{
		...
		$this->load->model('Mparu');
	}

	public function index()
	{
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/paru/Vindex');
	}

	public function create()
	{
        $data['icd'] = $this->Mparu->geticd();
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/paru/Vcreate', $data);
	}
