...
class Cbedahumum extends CI_Controller
{
	public function __construct()
	{
		...
		$this->load->model('Mbedahumum');
	}

	public function index()
	{
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/bedahumum/Vindex');
	}

	public function create()
	{
        $data['icd'] = $this->Mbedahumum->geticd();
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/bedahumum/Vcreate', $data);
	}
