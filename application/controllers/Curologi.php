...
class Curologi extends CI_Controller
{
	public function __construct()
	{
		...
		$this->load->model('Murologi');
	}

	public function index()
	{
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/urologi/Vindex');
	}

	public function create()
	{
        $data['icd'] = $this->Murologi->geticd();
		$this->template->load('rawatjalan/template', 'rawatjalan/assesment/urologi/Vcreate', $data);
	}
