<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?= base_url('rawatjalan/listpasien') ?>">Dokter</a></div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form class="form-horizontal style-form" id="pencarianantrian" method="post">
                                            <label class="control-label col-md-12"><h5>Daftar Pasien Rawat Jalan</h5></label>
                                            <div class="table-responsive">
                                                <p>Poliklinik :</p>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table table-bordered table-md">
                                            ...
                                            <td><div class="row">
                                            <div class="buttons">
                                            <a href="<?= base_url('') ?>" class="btn btn-icon btn-sm btn-warning"><i class="far fa-edit"></i></a>
