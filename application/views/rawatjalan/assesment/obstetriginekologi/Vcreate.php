<section class="section">
    <div class="section-header">
        <h1>Asesment Awal Medis Obstetri & Ginekologi</h1>
                                ...
                                <div class="row">
                                    <div class="card-body col-12">
                                        <div class="form">
                                            ...
                                            <input type="hidden" name="keluhanutama" value="<?= set_value('keluhanutama') ?>">
                                            <div id="keluhanutama" style="min-height: 160px;"><?= set_value('keluhanutama') ?></div>
                                        </div>
                                    </div>
                                    <div class="card-body col-12">
                                        <div class="form">
                                            <label for="riwayatkehamilan">Riwayat Kehamilan</label>
                                            <input type="hidden" name="riwayatkehamilan" value="<?= set_value('riwayatkehamilan') ?>">
                                            <div id="riwayatkehamilan" style="min-height: 160px;"><?= set_value('riwayatkehamilan') ?></div>
                                        </div>
                                        <div class="form">
                                            <div class="row">
                                                <div class="card-body col-2">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="riwayatkehamilang" class="form-control phone-number">
                                                    </div>
                                                </div>
                                                <div class="card-body col-2">
                                                    <label>P</label>
                                                    <div class="input-group">
                                                        <input type="text" name="riwayatkehamilanp" class="form-control phone-number">
                                                    </div>
                                                </div>
                                                <div class="card-body col-sm-3">
                                                    <div class="form">
                                                        <label>Haid Terakhir</label>
                                                        <input type="date" name="haidterakhir" class="form-control date">
                                                    </div>
                                                </div>
                                                <div class="card-body col-sm-3">
                                                    <div class="form">
                                                        <label>Tafsiran persalinan</label>
                                                        <input type="date" name="tafsiranpersalinan" class="form-control date">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body col-12">
                                        <div class="form">
                                            ...
                                            <input type="hidden" name="riwayatpersalinan" value="<?= set_value('riwayatpersalinan') ?>">
                                            <div id="riwayatpersalinan" style="min-height: 160px;"><?= set_value('riwayatpersalinan') ?></div>
                                        </div>
                                    </div>
                                    <div class="card-body col-12">
                                        <div class="form">
                                            <label for="riwayatanc">Riwayat ANC</label>
                                            <input type="hidden" name="riwayatanc" value="<?= set_value('riwayatanc') ?>">
                                            <div id="riwayatanc" style="min-height: 160px;"><?= set_value('riwayatanc') ?></div>
                                        </div>
                                    </div>
                                    <div class="card-body col-12">
                                        <div class="form">
                                            <label for="riwayatpenyakitlain">Riwayat Penyakit Lain</label>
                                            <input type="hidden" name="riwayatpenyakitlain" value="<?= set_value('riwayatpenyakitlain') ?>">
                                            <div id="riwayatpenyakitlain" style="min-height: 160px;"><?= set_value('riwayatpenyakitlain') ?></div>
                                        </div>
                                    </div>
                                    <div class="card-body col-12">
                                        <div class="form">
                                            <label for="riwayatpenyakitkeluarga">Riwayat Penyakit Keluarga</label>
                                            <input type="hidden" name="riwayatpenyakitkeluarga" value="<?= set_value('riwayatpenyakitkeluarga') ?>">
                                            <div id="riwayatpenyakitkeluarga" style="min-height: 160px;"><?= set_value('riwayatpenyakitkeluarga') ?></div>
                                        </div>
                                    </div>
                                    <div class="card-body col-12">
                                        <div class="form">
                                            <label for="riwayatkb">Riwayat KB</label>
                                            <input type="hidden" name="riwayatkb" value="<?= set_value('riwayatkb') ?>">
                                            <div id="riwayatkb" style="min-height: 160px;"><?= set_value('riwayatkb') ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="row">
                                                <div class="card-body col-sm-3">
                                                    <label>TFU</label>
                                                    <div class="input-group">
                                                        <input type="text" name="tfu" class="form-control phone-number">
                                                    </div>
                                                </div>
                                                <div class="card-body col-sm-3">
                                                    <label>Djj</label>
                                                    <div class="input-group">
                                                        <input type="text" name="djj" class="form-control phone-number">
                                                    </div>
                                                </div>
                                                <div class="card-body col-sm-3">
                                                    <label>Letak</label>
                                                    <div class="input-group">
                                                        <input type="text" name="letak" class="form-control phone-number">
                                                    </div>
                                                </div>
                                                <div class="card-body col-sm-3">
                                                    <label>His</label>
                                                    <div class="input-group">
                                                        <input type="text" name="his" class="form-control phone-number">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="card-body col-sm-5">
                                                    <label>VT</label>
                                                    <div class="input-group">
                                                        <input type="text" name="vt" class="form-control phone-number">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="card-body col-sm-5">
                                                    <label>USG Hamil</label>
                                                    <div class="input-group">
                                                        <input type="text" name="usghamil" class="form-control phone-number">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="card-body col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="penyulit"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
