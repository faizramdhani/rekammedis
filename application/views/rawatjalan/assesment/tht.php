        ...
        <div id="tab2" class="col-14" data-tab-group="mygroup-tab">
            <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="card-body col-12">
                        <div class="form">
                            <label>Arkus faring</label>
                            <input type="text" class="form-control" value="">
                        </div>
                    </div>
                    <div class="card-body col-12">
                        <div class="form">
                            <label>Dinding posterior</label>
                            <input type="text" class="form-control" value="">
                        </div>
                    </div>
                    <div class="card-body col-12">
                        <div class="form">
                            <label>Naso faring</label>
                            <input type="text" class="form-control" value="">
                        </div>
                    </div>
                    <div class="card-body col-12">
                ...
                <div class="row">
                    <div class="card-body col-12">
                        <div class="form-group">
                            <label>Tes pendengaran lainnya</label>
                            <textarea class="form-control"></textarea>
                        </div>
                    </div>
                </div>
