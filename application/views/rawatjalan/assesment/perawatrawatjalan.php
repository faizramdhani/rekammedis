            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-tab="mygroup-tab" href="#tab7">Kebutuhan Edukasi</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-tab="mygroup-tab" href="#tab7">Diagnosa Keparawatan</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-tab="mygroup-tab" href="#tab7">Rencana Asuhan Keperawatan</a>
                        </li>
                        </ul>
                    </div>
                </div>
