...
<section class="content">
    ...
    <div class="section-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-tab="mygroup-tab" href="#tab3">Psiko Sosial Spiritual dan Ekonomi</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-tab="mygroup-tab" href="#tab4">Skrining Gizi Awal</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-tab="mygroup-tab" href="#tab5">Asesmen Resiko Jatuh</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-tab="mygroup-tab" href="#tab6">Asesmen Nyeri</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-tab="mygroup-tab" href="#tab7">Status Fungsional</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-tab="mygroup-tab" href="#tab8">Kebutuhan Edukasi</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-tab="mygroup-tab" href="#tab9">Diagnosa Keparawatan</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-tab="mygroup-tab" href="#tab10">Rencana Asuhan Keperawatan</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div id="tab3" class="col-14" data-tab-group="mygroup-tab">
            <div class="card">
                <div class="card-header">
                    <h4>PSIKO SOSIAL SPIRITUAL DAN EKONOMI</h4>
                </div>
                <div class="row">
                    <div class="card-body col-12">
                        <div class="form">
