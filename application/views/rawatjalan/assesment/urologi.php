        ...
        <div id="tab2" class="col-14" data-tab-group="mygroup-tab">
            <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="card-body col-sm-3 col-md-6">
                        <div class="gallery gallery-fw" data-item-height="550">
                            <div class="gallery-item" data-image="<?= base_url() ?>/template/assets/img/assesment/urologi.jpg" data-title="Image 1"></div>
                        </div>
                    </div>
                </div>
            </div>
