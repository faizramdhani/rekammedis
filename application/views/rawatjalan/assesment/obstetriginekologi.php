                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-pills" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-tab="mygroup-tab" href="#tab6">Asesment Dokter Obstetri</a>
                            </li>
                ...
                <div class="row">
                    <div class="card-body">
                        <div class="custom-control custom-radio">
                            ...
                            <label class="custom-control-label" for="customRadio1">TFU</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="card-body">
                            <div class="custom-control custom-radio">
                                <input type="radio" id="customRadio1" name="customRadio" class="custom-control-input">
                                <label class="custom-control-label" for="customRadio1">Letak</label>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="custom-control custom-radio">
                            <input type="radio" id="customRadio1" name="customRadio" class="custom-control-input">
                            <label class="custom-control-label" for="customRadio1">HIS</label>
                        </div>
                    </div>
        ...
        <div id="tab5" class="col-14" data-tab-group="mygroup-tab">
            <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="card-body col-sm-3 col-md-6">
                        <div class="form">
                            <label>Pengobatan Rencana Tindakan</label>
                            <textarea class="form-control"></textarea>
                        </div>
                    </div>
                    <div class="card-body col-sm-3 col-md-6">
        ...
        <div id="tab6" class="col-14" data-tab-group="mygroup-tab">
            <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="card-header">
                        <h4>RENCANA PEMECAHAN MASALAH PERAWATAN</h4>
                    </div>
                    <div class="card-body col-sm-3 col-md-6">
                        <div class="form">
                            <label>Diagnosis Perawatan</label>
                            <textarea class="form-control"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="card-header">
                        <h4>DOKTER PENANGGUNGJAWAB PELAYANAN</h4>
                    </div>
                    <div class="card-body col-sm-3 col-md-6">
                        <div class="form">
