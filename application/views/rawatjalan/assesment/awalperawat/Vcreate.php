                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo site_url('Cassessmentawalperawat/insert') ?>" method="post" enctype="multipart/form-data" >
                                                ...
                                                <div class="form">
                                                    ...
                                                    <div class="row">
                                                        <div class="card-body">
                                                            ...
                                                            <input type="text" name="tb" class="form-control col-4">
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="form">
                                                                <label>BB</label>
                                                                <input type="text" name="bb" class="form-control col-4">
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="form">
                                                                <label>GCS</label>
                                                                <input type="text" name="gcs" class="form-control col-4">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form">
                                                    ...
                                                    <div class="row">
                                                        <div class="card-body">
                                                            <div class="form">
                                                                <label>TD</label>
                                                                <input type="text" name="td" class="form-control col-4">
                                                                <p>mmhg</p>
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="form">
                                                                <label>Suhu</label>
                                                                <input type="text" name="suhu" class="form-control col-4">
                                                                <p>oC</p>
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="form">
                                                                <label>Nadi</label>
                                                                <input type="text" name="nadi" class="form-control col-4">
                                                                <p>x/mnt</p>
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="form">
                                                                <label>RR</label>
                                                                <input type="text" name="rr" class="form-control col-4">
                                                                <p>x/mnt</p>
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="form">
                                                                <label>GDA</label>
                                                                <input type="text" name="gda" class="form-control col-4">
                                                                <p>mg/dl</p>
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="form">
                                                                <label>SpO2</label>
                                                                <input type="text" name="spo2" class="form-control col-4">
                                                                <p>%</p>
                                                            </div>
                                                        </div>
                            ...
                            <div id="tab8" class="col-14" data-tab-group="mygroup-tab">                             
                                ...
                                <div class="form">
                                    <label class="col-sm-3">Bicara</label>
                                    <div class="form">
                                        <div class="card-body">
                                            <div class="form">
                                                <div class="form-group">
                                    ...
                                    <div class="form">
                                        <label class="col-sm-3">Perlu Penerjemah</label>
                                        <div class="row">
                                            <div class="card-body">
                                                <div class="form">
                                    ...
                                    <div class="form">
                                        <label class="col-sm-3">Kebutuhan Pembelajaran</label>
                                        <div class="row">
                                            <div class="card-body">
                                                <div class="form">
                                                    <div class="form-group-row">
                            ...
                            <div id="tab9" class="col-14" data-tab-group="mygroup-tab">
                                <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="card-body col-12">
                                            <div class="form-group">
                                                <textarea name="diagnosa_keperawatan" class="form-control"></textarea>
                                            </div>
