                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="nav-link" href="<?= site_url('Crehabmedik/index') ?>"><i class="fas fa-user-injured"></i> <span>Rehab Medik</span></a></li>
                                    <li><a class="nav-link" href="<?= site_url('Ctht/index') ?>"><i class="fas fa-user-injured"></i> <span>THT</span></a></li>
                                    <li><a class="nav-link" href="<?= site_url('Curologi/index') ?>"><i class="fas fa-user-injured"></i> <span>Urologi</span></a></li>
                                    <li><a class="nav-link" href="<?= site_url('Cgigi/index') ?>"><i class="fas fa-user-injured"></i> <span>Gigi</span></a></li>
                                    ...
                                    <li><a class="nav-link" href="<?= site_url('Cbedahplastik/index') ?>"><i class="fas fa-user-injured"></i> <span>Bedah Plastik</span></a></li>
                                    <li><a class="nav-link" href="<?= site_url('Ckesehatanjiwa/index') ?>"><i class="fas fa-user-injured"></i> <span>Kesehatan Jiwa</span></a></li>
