<section class="section">
    <div class="section-header">
        <h5>Asessment Awal Keperawatan</h5>
                                    ...
                                    <div class="card-body col-12">
                                        ...
                                        <table class="table table-hover table-sm col-12">
                                            ...
                                            <tbody>
                                                <!-- 1 -->
                                                <tr>
                                                    <th class="col-sm-3">Face</th>
                                                    <td>Tidak ada ekspresi tertentu atau senyuman</td>
                                                    <td class="col-sm-4">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1" style="height:20px;width:20px">
                                                            <label class="form-check-label" for="inlineCheckbox1">
                                                ...
                                                <tr>
                                                    <th></th>
                                                    <td>Menyeringkal sesekali atau mengerutkan dahi muram ogah - ogahan</td>
                                                    <td>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1" style="height:20px;width:20px">
                                                            <label class="form-check-label" for="inlineCheckbox1">
                                                ...
                                                <tr>
                                                    <th></th>
                                                    <td>Dagu gemetar dan rahang diketap berulang</td>
                                                    <td>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1" style="height:20px;width:20px">
                                                            <label class="form-check-label" for="inlineCheckbox1">
                                            ...
                                            <tr>
                                                <th></th>
                                                <td>Menekuk/posisi tubuh meringkuk, kaku atau menyentak</td>
                                                <td>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1" style="height:20px;width:20px">
                                                        <label class="form-check-label" for="inlineCheckbox1">
                                            ...
                                            <tr>
                                                <th>Cry</th>
                                                <td>Tidak ada tangisan (terjaga/tertidur)</td>
                                                <td>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1" style="height:20px;width:20px">
                                                        <label class="form-check-label" for="inlineCheckbox1">
                                            ...
                                            <tr>
                                                <th></th>
                                                <td>Mengerang/merengek, gerurutan sesekali</td>
                                                <td>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1" style="height:20px;width:20px">
                                                        <label class="form-check-label" for="inlineCheckbox1">
                                            ...
                                            <tr>
                                                <th></th>
                                                <td>
                                                    Dapat ditenangkan dengan sentuhan, pelukan atau berbicara, dapat dialihkan</td>
                                                <td>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1" style="height:20px;width:20px">
                                                        <label class="form-check-label" for="inlineCheckbox1">
                            ...
                            <div class="tab-pane fade" id="skriningnutrisional1" role="tablist" aria-labelledby="skriningnutrisional-tab1">
                                ...
                                <table class="table table-hover table-sm col-12">
                                    ...
                                    <tbody>
                                        ...
                                        <th class="col-1">1</th>
                                        <td class="col-5">Apakah pasien tampak kurus?</td>
                                        ...
                                        <tr>
                                            <th scope="row">4</th>
                                            <td>Apakah terdapat penyakit atau keadaan yang mengakibatkan pasien beresiko mengalami menstruasi?</td>
                                            <td>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1" style="height:20px;width:20px">
                                                    <label class="form-check-label" for="inlineCheckbox1">
