            ...
            <div id="tab1" class="col-12 active" data-tab-group="mygroup-tab">
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="card-body col-sm-4 col-md-6">
                            <div class="form-group row align-items-center">
                                <label class="col-md">Jenis Kelamin</label>
                                <div class="col-lg-9 col-md-9">
                                    <input type="text" class="form-control" name="nama">
                                </div>
                            ...
                            <!-- <div class="form-group row">
                                <div class="col-md-6"></div>
                                <div class="col-lg-4 col-md-6 text-center">
                                    <button class="btn btn-icon icon-center btn-warning" href="#tab2">Kembali <i class="fas fa-arrow-left"></i></button>
                                </div>
                            </div> -->
                        </div>
                    </div>
            ...
            <div id="tab2" class="col-12" data-tab-group="mygroup-tab">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-6 text-right">
                        <button class="btn btn-icon icon-center btn-primary" name="tab2" href="#tab2">Selanjutnya <i class="fas fa-arrow-right"></i></button>
                    </div>
                </div>
                <!-- <div class="form-group row">
                                <div class="col-md-6"></div>
