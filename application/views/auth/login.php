...
<body>
   <div class="col-lg-20 col-12 order-lg-300 order-1 min-vh-250 "
      style="background-image: url('<?= base_url() ?>/template/assets/img/unsplash/background.jpg'); background-size: cover;min-height: 100vh; margin-top: -3rem;">
               ...
               <div class="row">
                  <div
                     ...
                     <div class="login-brand">
                        <img src="<?= base_url() ?>/template/assets/img/ihc-nmu.png" alt="logo" width="180"
                           height="180">
                     </div>
                     <div class="card card-primary">
                        ...
                        <div class="card-body">
                           <form action="<?= site_url('auth/proses') ?>" method="POST" class="needs-validation"
                              novalidate="">
